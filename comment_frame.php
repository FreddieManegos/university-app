	...
	*{
	...
	if(isset($_SESSION['username'])){
	 ...
	 <?php 
	 	...
	 	$user_query = pg_query($db, "SELECT added_by, course_to FROM discussions WHERE id='$post_id'");
	 	...
	 	if(isset($_POST['postComment'.$post_id]) && $_POST['postComment'.$post_id] != "" && $_POST['post_body'] != "") {
	 		...
	 		$insert_post = pg_query($db, "INSERT INTO comments(post_body,  posted_by, posted_to, date_added, removed, post_id) VALUES ('$post_body','$userLoggedIn', '$posted_to','$date_time_now','no','$post_id')");
	 	}
	  ...
	  <?php 	
	  	$get_comments = pg_query($db, "SELECT * FROM comments WHERE  post_id='$post_id' ORDER BY id DESC");
