...
<body>
	<div class = "top_bar">
		<div class = "logo">
			<?php if($user['users'] == 'student') {
				echo '<a href="index.php" ><img src="\UniversityApp\assets\Images\myIIT.jpg" ></a>';
			} else { 
				echo '<a href="adminindex.php" ><img src="\UniversityApp\assets\Images\myIIT.jpg"></a>';
			} ?>
		</div>	
		<div class="search">
		...
		<nav>
			...
			<?php } else if ($user['users'] == 'admin') {
				?><a href="adminindex.php"><i class="fa fa-home fa-lg" aria-hidden="true"></i> </a> 
			<?php } 
			?> 
				<?php if($user['users'] == 'student') { ?>
