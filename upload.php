...
/***********************************************************
	...
	***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/UniversityApp/assets/Images/profile_pics';
	//Set File name	
	...
	***********************************************************/
	...
	//the image src
		...
		//Insert image into database
			$insert_pic_query = pg_query($db, "UPDATE users SET profile_pic='$result_path' WHERE username='$userLoggedIn'");
			header("Location: ".$userLoggedIn);
}// post x
?>
<div id="upload_main_column">
	...
	<div id="formExample">
		...
		<form action="upload.php" method="post"  enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-11">
					<h3>Upload your Profile Piture</h3> 
				</div> 
			</div>
			<div class="row">
				<div class="col-lg-11">
			...
			<div class="row">
				<div class="col-lg-11">
					<input class="btn upload_btn" type="submit" value="Submit"/>
				</div>
			</div>
		</form>
	...
	<div id="CroppingContainer">  
		<div class="row"> 
			<div class="col-lg-11"> 
				<h3><b style="color:#444">Crop Profile Image</b></h3>
			</div>
		</div>
		<div id="CroppingArea">
		...
		<div id="InfoArea">	
			<div class="row"> 
				<div class="col-md-12">
					<p style="text-align: center; margin-top: 2%">Crop or resize the image you uploaded, then click "Save".</p> 
				</div>
			</div>
		</div>  
		...
		<div id="CropImageForm">  
			<form action="upload.php" method="post" onsubmit="return checkCoords();">
				...
				<div class="col-lg-3"><input class="btn upload_btn" type="submit" value="Save"/></div>
			</form>
			<form action="upload.php" method="post" onsubmit="return cancelCrop();">
				<div class="col-lg-3"><input class="btn upload_btn" type="submit" value="Cancel"/></div>
			</form>
		</div>        
